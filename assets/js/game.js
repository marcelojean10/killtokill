    ...
    var mainState = {
        ...
        preload:function(){
            game.load.image('spacefield', path+"img/spacefield.jpg");
            game.load.image('player', path+"img/player.png");
            game.load.image('bullet', path+"img/bullet.png");
            game.load.image('enemy',  path+"img/enemy.png");
            game.load.audio('stars', path+"audio/stars.ogg");
        },
